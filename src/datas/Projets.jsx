import booki from "../assets/images/booki.png"; import brico from "../assets/images/briconnect.png"; import bluel from "../assets/images/sophie-bluel.png"; import nina from "../assets/images/nina.png"; import kasa from "../assets/images/kasa.png"; import monvieuxgrimoire from "../assets/images/monvieuxgrimoire.png"; import qwenta from "../assets/images/qwenta.png"; import onze from "../assets/images/11sur10.png"; import htmlcss from "../assets/logos/htmlcss.png"; import javascript from "../assets/logos/javascript.png"; import react from "../assets/logos/react.png"; import sass from "../assets/logos/sass.png"; import reactNative from "../assets/logos/reactnative.png"; import mongodb from "../assets/logos/mongodb.png"; import nodejs from "../assets/logos/nodejs.png"; import notion from "../assets/logos/notion.png"; import seo from "../assets/logos/seo.png"; import express from "../assets/logos/express.png"; import github from "../assets/logos/github.png"; import figma from "../assets/logos/figma.png"
...
export const projets =
    [
        ...
        },
        {
            ...
            "description": "Projet personnel développé en utilisant React et React Native dans lequel j'affiche des données footbalistiques (classements, resultats, statistiques...) récupérées via une API",
            "technologies": [
                {
                    "nom": "React Native",
                    "logo": reactNative
            ...
            "objectifs": [
                ...
                "Creer une application mobile et la deployer sur les stores (App Store et Playstore)",
                "Mettre en place le backend afin de gerer l'envoi de notifications Push pour certains evenement pendant les matchs"
            ]
        },

        {
            ...
            "description": "Plateforme de mise en relation entre bricoleurs et particuliers",
            "technologies" : [
                {
                    "nom": "React Native",
                    "logo": reactNative
            ...
            "github": "https://github.com/brucemvl/brico.git",
            "objectifs": [
                "Mise en place de comptes utilisateurs",
                "Récuperer et exploiter des données via la base MongoDB",
                "Utilisation de composants réutilisables",
                "Implementer une interface responsive",
                "Creer une application mobile et la deployer sur les stores (App Store et Playstore)",
                "Mettre en place le backend afin de gerer l'envoi de notifications Push, la gestion des comptes utilisateurs et l'envoie de données vers la base MongoDB"
            ]
        }
